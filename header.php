			...
			<div class="flex flex-row justify-between">
					...
					<?php
						wp_nav_menu(
							array(
								'container'       => 'nav',
								'container_class' => '',
								'menu_class'      => 'flex flex-row gap-3 md:gap-8 whitespace-nowrap',
				...
				<?php
					wp_nav_menu(
						array(
							'container'       => 'nav',
							'container_class' => 'hidden md:inline',
							'menu_class'      => 'flex flex-row lg:gap-8 whitespace-nowrap',
