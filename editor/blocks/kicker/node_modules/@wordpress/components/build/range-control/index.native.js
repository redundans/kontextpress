...
function RangeControl(_ref) {
  var className = _ref.className,
      ...
      min = _ref.min,
      max = _ref.max,
      props = (0, _objectWithoutProperties2.default)(_ref, ["className", "currentInput", "label", "value", "instanceId", "onChange", "beforeIcon", "afterIcon", "help", "allowReset", "initialPosition", "min", "max"]);
