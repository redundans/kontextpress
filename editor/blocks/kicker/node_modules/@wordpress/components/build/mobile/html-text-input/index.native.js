...
function (_Component) {
  ...
  function HTMLTextInput() {
    ...
    (0, _hooks.addAction)('native-editor.persist-html', 'core/editor', _this.stopEditing);
    _this.state = {};
    return _this;
  }
  ...
  (0, _createClass2.default)(HTMLTextInput, [{
    ...
    value: function componentWillUnmount() {
      (0, _hooks.removeAction)('native-editor.persist-html', 'core/editor'); //TODO: Blocking main thread
