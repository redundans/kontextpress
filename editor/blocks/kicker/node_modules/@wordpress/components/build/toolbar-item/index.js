...
function ToolbarItem(_ref, ref) {
  ...
  var accessibleToolbarState = (0, _element.useContext)(_toolbarContext.default); // https://reakit.io/docs/composition/#props-hooks

  var itemProps = (0, _Toolbar.useToolbarItem)(accessibleToolbarState, _objectSpread({}, props, {
    ref: ref
  }));
  ...
  if (!accessibleToolbarState) {
    typeof process !== "undefined" && process.env && process.env.NODE_ENV !== "production" ? (0, _warning.default)('`ToolbarItem` should be rendered within `<Toolbar __experimentalAccessibilityLabel="label">`') : void 0;
    return null;
  }
