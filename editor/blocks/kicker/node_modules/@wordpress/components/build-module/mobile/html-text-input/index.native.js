...
function (_Component) {
  ...
  function HTMLTextInput() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(HTMLTextInput).apply(this, arguments));
    ...
    addAction('native-editor.persist-html', 'core/editor', _this.stopEditing);
    _this.state = {};
    return _this;
  }
  ...
  _createClass(HTMLTextInput, [{
    ...
    value: function componentWillUnmount() {
      removeAction('native-editor.persist-html', 'core/editor'); //TODO: Blocking main thread
