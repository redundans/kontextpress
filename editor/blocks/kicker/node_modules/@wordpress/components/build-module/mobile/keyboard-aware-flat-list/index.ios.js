...
export var KeyboardAwareFlatList = function KeyboardAwareFlatList(_ref) {
  var extraScrollHeight = _ref.extraScrollHeight,
      ...
      listProps = _objectWithoutProperties(_ref, ["extraScrollHeight", "shouldPreventAutomaticScroll", "innerRef", "autoScroll", "scrollViewStyle"]);
  ...
  }, createElement(FlatList, listProps));
};
