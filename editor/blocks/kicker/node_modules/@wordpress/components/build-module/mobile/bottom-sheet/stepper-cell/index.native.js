...
function (_Component) {
  ...
  function BottomSheetStepperCell(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(BottomSheetStepperCell).call(this, props));
  ...
  _createClass(BottomSheetStepperCell, [{
    ...
    value: function onDecrementValue() {
      var _this$props2 = this.props,
          ...
          onChangeValue = _this$props2.onChangeValue,
    ...
    value: function startPressInterval(callback) {
      ...
      this.interval = setInterval(function () {
        ...
        if (counter === 10) {
          ...
          _this4.startPressInterval(callback, STEP_SPEED / 2);
        }
      }, STEP_SPEED);
    }
  }, {
    ...
    value: function render() {
      ...
      var isMinValue = value === minValue;
      var isMaxValue = value === maxValue;
