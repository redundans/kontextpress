...
function RangeControl(_ref) {
  ...
  var initialFallbackValue = isFinite(initialPosition) ? initialPosition : '';
  var initialSliderValue = isFinite(currentInputValue) ? currentInputValue : initialFallbackValue;
