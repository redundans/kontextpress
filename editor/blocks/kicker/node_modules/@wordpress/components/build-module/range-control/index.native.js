...
function RangeControl(_ref) {
  var className = _ref.className,
      ...
      min = _ref.min,
      max = _ref.max,
      props = _objectWithoutProperties(_ref, ["className", "currentInput", "label", "value", "instanceId", "onChange", "beforeIcon", "afterIcon", "help", "allowReset", "initialPosition", "min", "max"]);
