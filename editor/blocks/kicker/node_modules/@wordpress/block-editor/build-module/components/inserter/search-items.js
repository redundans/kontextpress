...
export var searchItems = function searchItems(items, categories, collections, searchTerm) {
  ...
  return items.filter(function (_ref) {
    ...
    unmatchedTerms = removeMatchingTerms(unmatchedTerms, get(find(categories, {
      slug: category
    }), ['title']));
