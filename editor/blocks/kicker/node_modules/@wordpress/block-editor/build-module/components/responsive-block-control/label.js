...
export default function ResponsiveBlockControlLabel(_ref) {
  ...
  var accessibleLabel = desc || sprintf(_x('Controls the %1$s property for %2$s viewports.', 'Text labelling a interface as controlling a given layout property (eg: margin) for a given screen size.'), property, viewport.label);
  return createElement(Fragment, null, createElement("span", {
    "aria-describedby": "rbc-desc-".concat(instanceId)
  }, viewport.label), createElement("span", {
