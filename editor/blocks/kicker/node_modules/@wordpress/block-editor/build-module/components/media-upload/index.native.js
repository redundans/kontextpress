...
import { getOtherMediaOptions, requestMediaPicker, mediaSources } from 'react-native-gutenberg-bridge';
/**
...
function (_React$Component) {
  ...
  function MediaUpload(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(MediaUpload).call(this, props));
  ...
  _createClass(MediaUpload, [{
    ...
    value: function getMediaOptionsItems() {
      ...
      var _this$props = this.props,
          ...
          multiple = _this$props$multiple === void 0 ? false : _this$props$multiple; // disable upload sources for now when multiple flag is set
      ...
      return this.getAllSources().filter(function (source) {
        return allowedTypes.filter(function (allowedType) {
