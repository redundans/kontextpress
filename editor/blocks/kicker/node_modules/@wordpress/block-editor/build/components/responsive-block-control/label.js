...
function ResponsiveBlockControlLabel(_ref) {
  ...
  var accessibleLabel = desc || (0, _i18n.sprintf)((0, _i18n._x)('Controls the %1$s property for %2$s viewports.', 'Text labelling a interface as controlling a given layout property (eg: margin) for a given screen size.'), property, viewport.label);
  ...
  }, viewport.label), (0, _element.createElement)("span", {
