...
function (_Component) {
  ...
  function BlockEdit() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(BlockEdit).apply(this, arguments)); // It is important to return the same object if props haven't changed
