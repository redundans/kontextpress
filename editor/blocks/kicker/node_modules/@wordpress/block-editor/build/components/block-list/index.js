...
function BlockList(_ref) {
  ...
  var Container = rootClientId ? 'div' : _rootContainer.default;
  ...
  return (0, _element.createElement)(Container, (0, _extends2.default)({
    ref: ref,
    className: (0, _classnames.default)('block-editor-block-list__layout', className)
...
var _default = forceSyncUpdates(BlockList);
